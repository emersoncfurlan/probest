...
public class telaMain {
	...
	private void initialize() {
		...
		gl_somatorio.setHorizontalGroup(gl_somatorio.createParallelGroup(Alignment.LEADING).addGroup(gl_somatorio
				...
				.addGroup(gl_somatorio.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_somatorio.createSequentialGroup()
								.addGroup(gl_somatorio.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdSomatorio, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxSomatorio, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61).addComponent(textPSomatorio, GroupLayout.PREFERRED_SIZE, 650,
										GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(56, Short.MAX_VALUE)));
		gl_somatorio.setVerticalGroup(gl_somatorio.createParallelGroup(Alignment.LEADING).addGroup(gl_somatorio
				.createSequentialGroup().addGap(20).addComponent(lblSomatrio).addGap(6)
				.addGroup(gl_somatorio.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_somatorio.createSequentialGroup()
								.addComponent(textFdSomatorio, GroupLayout.PREFERRED_SIZE, 35,
										GroupLayout.PREFERRED_SIZE)
								.addGap(2).addComponent(checkBxSomatorio))
		...
		gl_mediaS.setHorizontalGroup(gl_mediaS.createParallelGroup(Alignment.LEADING).addGroup(gl_mediaS
				.createSequentialGroup().addGap(32)
				.addGroup(gl_mediaS.createParallelGroup(Alignment.LEADING).addComponent(chckbxMediaARS)
						.addComponent(chckbxMediaAritmeticaPond).addComponent(lblMediaAritmeticaPonderada)
						.addComponent(chckbxMediaGeometrica).addComponent(chckbxMediaHarmonica)
						.addComponent(lblMediaGeometrica).addComponent(lblMediaHarmonica).addComponent(lblmediaARS)
						.addComponent(textFdMediaGeometrica, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(textFdMediaAritmeticaPond, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(textFdMediaHarmonica, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(textFdMediaARS, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				...
				.addGroup(gl_mediaS.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(textPMediaAritmeticaPond, GroupLayout.PREFERRED_SIZE, 650,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(textPMediaHarmonica, GroupLayout.PREFERRED_SIZE, 650, GroupLayout.PREFERRED_SIZE)
						.addComponent(textPMediaGeometrica, GroupLayout.PREFERRED_SIZE, 650,
								GroupLayout.PREFERRED_SIZE))
				.addContainerGap(45, Short.MAX_VALUE)));
		gl_mediaS.setVerticalGroup(gl_mediaS.createParallelGroup(Alignment.LEADING).addGroup(gl_mediaS
				.createSequentialGroup().addGap(18).addComponent(lblmediaARS)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_mediaS.createParallelGroup(Alignment.LEADING).addGroup(gl_mediaS.createSequentialGroup()
						.addComponent(textFdMediaARS, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(chckbxMediaARS).addGap(43)
				...
				.addGroup(gl_mediaS.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_mediaS.createSequentialGroup()
								.addComponent(textFdMediaAritmeticaPond, GroupLayout.PREFERRED_SIZE, 35,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(chckbxMediaAritmeticaPond)
								.addGap(51).addComponent(lblMediaHarmonica))
						.addComponent(
								textPMediaAritmeticaPond, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_mediaS.createParallelGroup(Alignment.LEADING).addGroup(gl_mediaS.createSequentialGroup()
						.addComponent(textFdMediaHarmonica, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(chckbxMediaHarmonica).addGap(42)
				...
				.addGroup(gl_mediaS.createParallelGroup(Alignment.LEADING).addGroup(gl_mediaS.createSequentialGroup()
						...
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(chckbxMediaGeometrica))
		...
		gl_moda.setHorizontalGroup(gl_moda.createParallelGroup(Alignment.LEADING).addGroup(gl_moda
				...
				.addGroup(gl_moda.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_moda.createSequentialGroup()
								.addGroup(gl_moda.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdModa, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxModa, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61)
								.addComponent(textPModa, GroupLayout.PREFERRED_SIZE, 650, GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(50, Short.MAX_VALUE)));
		gl_moda.setVerticalGroup(gl_moda.createParallelGroup(Alignment.LEADING).addGroup(gl_moda.createSequentialGroup()
				.addGap(22).addComponent(lblModa).addGap(6)
				.addGroup(gl_moda.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_moda.createSequentialGroup()
								.addComponent(textFdModa, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
								.addGap(2).addComponent(checkBxModa))
		...
		gl_mediana.setHorizontalGroup(gl_mediana.createParallelGroup(Alignment.LEADING).addGroup(gl_mediana
				...
				.addGroup(gl_mediana.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_mediana.createSequentialGroup()
								.addGroup(gl_mediana.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdMediana, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxMediana, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61).addComponent(textPMediana, GroupLayout.PREFERRED_SIZE, 650,
										GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(46, Short.MAX_VALUE)));
		gl_mediana.setVerticalGroup(gl_mediana.createParallelGroup(Alignment.LEADING).addGroup(gl_mediana
				.createSequentialGroup().addGap(26).addComponent(label_2).addGap(6)
				.addGroup(gl_mediana.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_mediana.createSequentialGroup()
								.addComponent(textFdMediana, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
								.addGap(2).addComponent(checkBxMediana))
		...
		gl_variancia.setHorizontalGroup(gl_variancia.createParallelGroup(Alignment.LEADING).addGroup(gl_variancia
				...
				.addGroup(gl_variancia.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_variancia.createSequentialGroup()
								.addGroup(gl_variancia.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdVarianca, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxVariancia, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61).addComponent(textPVariancia, GroupLayout.PREFERRED_SIZE, 650,
										GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(51, Short.MAX_VALUE)));
		gl_variancia.setVerticalGroup(gl_variancia.createParallelGroup(Alignment.LEADING).addGroup(gl_variancia
				.createSequentialGroup().addGap(25).addComponent(lblVariana).addGap(6)
				.addGroup(gl_variancia.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_variancia.createSequentialGroup()
								.addComponent(textFdVarianca, GroupLayout.PREFERRED_SIZE, 35,
										GroupLayout.PREFERRED_SIZE)
								.addGap(2).addComponent(checkBxVariancia))
		...
		gl_desvioPadrao.setHorizontalGroup(gl_desvioPadrao.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_desvioPadrao.createSequentialGroup().addGap(28).addGroup(gl_desvioPadrao
						...
						.addGroup(gl_desvioPadrao.createSequentialGroup()
								.addGroup(gl_desvioPadrao.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdDesvioPadrao, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxDesvioPadrao, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61).addComponent(textPDesvioPadrao, GroupLayout.PREFERRED_SIZE, 650,
										GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(49, Short.MAX_VALUE)));
		gl_desvioPadrao.setVerticalGroup(gl_desvioPadrao.createParallelGroup(Alignment.LEADING).addGroup(gl_desvioPadrao
				.createSequentialGroup().addGap(28).addComponent(lblDesvioPadro).addGap(6)
				.addGroup(gl_desvioPadrao.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_desvioPadrao.createSequentialGroup()
								.addComponent(textFdDesvioPadrao, GroupLayout.PREFERRED_SIZE, 35,
										GroupLayout.PREFERRED_SIZE)
								.addGap(2).addComponent(checkBxDesvioPadrao))
		...
		gl_produto.setHorizontalGroup(gl_produto.createParallelGroup(Alignment.LEADING).addGroup(gl_produto
				...
				.addGroup(gl_produto.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_produto.createSequentialGroup()
								.addGroup(gl_produto.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdProduto, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxProduto, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61).addComponent(textPProduto, GroupLayout.PREFERRED_SIZE, 650,
										GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(52, Short.MAX_VALUE)));
		gl_produto.setVerticalGroup(gl_produto.createParallelGroup(Alignment.LEADING).addGroup(gl_produto
				.createSequentialGroup().addGap(28).addGap(3).addComponent(lblProduto).addGap(6)
				.addGroup(gl_produto.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_produto.createSequentialGroup()
								.addComponent(textFdProduto, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
								.addGap(2).addComponent(checkBxProduto))
		...
		gl_probabilidade.setHorizontalGroup(gl_probabilidade.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_probabilidade.createSequentialGroup().addGap(29).addGroup(gl_probabilidade
						.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_probabilidade.createSequentialGroup()
								.addGroup(gl_probabilidade.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdProbabilidade, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxProbabilidade, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61).addComponent(textPProbabilidade, GroupLayout.PREFERRED_SIZE, 650,
										GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(48, Short.MAX_VALUE)));
		gl_probabilidade.setVerticalGroup(gl_probabilidade.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_probabilidade.createSequentialGroup().addGap(28).addComponent(lblProbabilidade).addGap(6)
						.addGroup(gl_probabilidade.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_probabilidade.createSequentialGroup()
										.addComponent(textFdProbabilidade, GroupLayout.PREFERRED_SIZE, 35,
												GroupLayout.PREFERRED_SIZE)
										.addGap(2).addComponent(checkBxProbabilidade))
								.addComponent(textPProbabilidade, GroupLayout.PREFERRED_SIZE, 89,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap(394, Short.MAX_VALUE)));
		...
		checkBxFatorial.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (checkBxFatorial.isSelected()) {
					textPFatorial.setText("Fatorial recursivo");
				} else {
					textPFatorial.setText("");
				}
			}
		...
		gl_fatorial.setHorizontalGroup(gl_fatorial.createParallelGroup(Alignment.LEADING).addGroup(gl_fatorial
				...
				.addGroup(gl_fatorial.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_fatorial.createSequentialGroup()
								.addGroup(gl_fatorial.createParallelGroup(Alignment.LEADING)
										.addComponent(textFdFatorial, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(checkBxFatorial, GroupLayout.PREFERRED_SIZE, 97,
												GroupLayout.PREFERRED_SIZE))
								.addGap(61).addComponent(textPFatorial, GroupLayout.PREFERRED_SIZE, 650,
										GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(48, Short.MAX_VALUE)));
		gl_fatorial.setVerticalGroup(gl_fatorial.createParallelGroup(Alignment.LEADING).addGroup(gl_fatorial
				.createSequentialGroup().addGap(29).addComponent(lblFatorial).addGap(6)
				.addGroup(gl_fatorial.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_fatorial.createSequentialGroup()
								.addComponent(textFdFatorial, GroupLayout.PREFERRED_SIZE, 35,
										GroupLayout.PREFERRED_SIZE)
								.addGap(2).addComponent(checkBxFatorial))
